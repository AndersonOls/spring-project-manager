    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/projects").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.POST, "/projects").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.PUT, "/projects/{id}").hasRole("MANAGER")
                        .requestMatchers(HttpMethod.DELETE, "/projects/{id}").hasRole("MANAGER")
